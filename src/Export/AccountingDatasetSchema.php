...
final class AccountingDatasetSchema
{
    ...
    public const COLUMNS = [
        ...
        'fints_sync_runs' => 'id uuid legal_entity_id bank_connection_id accounting_bank_account_id type status from_date to_date requested_from_date item_count error_code error_message started_at finished_at created_at updated_at',
